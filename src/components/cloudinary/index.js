...
class CldCustUploadLgRestApi extends Component {
  processFile = async (e) => {
    ...
    var YOUR_CLOUD_NAME = "dqhop939m";
    var YOUR_UNSIGNED_UPLOAD_PRESET = "vx7i2mlm";

    var POST_URL = `https://api.cloudinary.com/v1_1/${YOUR_CLOUD_NAME}/upload`;
  ...
  render() {
    return (
      <div>
        <h3>Upload:</h3>
        <p>
          Note: Before choosing a file, set your cloud name and unsigned upload preset in CldCustUploadLgRestApi.js:
        </p>
        <p>YOUR_CLOUD_NAME</p>
